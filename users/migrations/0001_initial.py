# Generated by Django 5.2.2 on 2025-06-10 14:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('reader', 'Читатель'), ('writer', 'Писатель'), ('moderator', 'Модератор'), ('admin', 'Администратор')], default='reader', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('following_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followers', to='users.user')),
